...
import com.dflow.databinding.FragmentDetailBinding
...
class DetailFragment : BindingFragment<FragmentDetailBinding>() {
    ...
    override fun inflate(inflater: LayoutInflater, parent: ViewGroup?, attachToParent: Boolean): FragmentDetailBinding = FragmentDetailBinding.inflate(inflater)
